<div class="container auth-wrapper" style="min-height:calc(100vh - 120px);display:flex;align-items:center;justify-content:center;">
    <div class="auth-card" style="width:100%;max-width:560px;background:#0c0e12;border:1px solid rgba(255,255,255,.08);border-radius:16px;box-shadow:0 14px 50px rgba(0,0,0,.45), inset 0 1px 0 rgba(255,255,255,.04);padding:24px 24px;">
        ...
        <div class="auth-tabs mb-3">
            <button type="button" class="auth-tab-btn" data-tab="login">Đăng nhập</button>
            <button type="button" class="auth-tab-btn" data-tab="register">Đăng ký</button>
        </div>
        ...
        <div class="tab-panels">
            ...
            <div class="tab-panel" id="panel-login">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <label for="email" class="text-light" style="opacity:.9;">Email</label>
                    ...
                    <div class="form-group mt-3">
                        <label for="password" class="text-light" style="opacity:.9;">Password</label>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3">
                        ...
                        <a class="text-muted" href="{{ route('password.request') }}" style="text-decoration:underline;">Forgot your password?</a>
                        @endif
                    </div>
                    <div class="mt-4 d-flex justify-content-end">
                        <button type="submit" class="btn btn-cta" style="min-width:140px;">LOG IN</button>
                    </div>
                </form>
            </div>
            ...
            <div class="tab-panel" id="panel-register">
                ...
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="form-group">
                        <label for="name" class="text-light" style="opacity:.9;">Name</label>
                    ...
                    <div class="form-group mt-3">
                        <label for="reg_email" class="text-light" style="opacity:.9;">Email</label>
                    ...
                    <div class="form-group mt-3">
                        <label for="reg_password" class="text-light" style="opacity:.9;">Password</label>
                    ...
                    <div class="form-group mt-3">
                        <label for="password_confirmation" class="text-light" style="opacity:.9;">Confirm Password</label>
                    ...
                    <div class="mt-4 d-flex justify-content-end">
                        <button type="submit" class="btn btn-cta" style="min-width:140px;">REGISTER</button>
                    </div>
                </form>
            </div>
        </div>
